    ...
    <div className={`${className} flex flex-1 flex-col min-h-[700px] w-[400px]`}>
      ...
      <div className="bg-brownBlack p-8">
        <div className="flex flex-col">
          <Button to={to} className="w-[200px]" type="primary-non-border">
            {title}
          </Button>
    ...
    <>
      <div className={`flex flex-col md:flex-row md:h-[500px] md:px-24 pt-28 xl:justify-center`}>
        ...
        <div className="flex flex-col md:flex-row md:absolute md:top-56 md:right-16 xl:relative xl:top-0 xl:right-0">
          <AboutItem title='Our Vision' image={images.worker4} to='#vision' 
          content='Innovative Transformation' className='mr-8' />

          <AboutItem title='Our Values' image={images.officeMan} to='/value' 
          content='Integrity, Excellence, Collaboration' />
        </div>
      </div>


      <div
        className={`md:h-[800px] px-2 md:px-56 pt-20 md:pt-96`}
      ...
      <div
        className={`flex flex-col px-2 md:px-28 py-20`}
      >
